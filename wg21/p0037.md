...
SG6: Lawrence Crowl, Davis Herring, Lisa Lippincott  
...
* rename `fixed_point` to `scaled_integer` at following feedback from SG6 and
  LEWG in Kona
...
P0037R6 revises [P0037R5](https://github.com/johnmcfarlane/papers/blob/master/wg21/p0037r5.md):
